...
const SUBCATS = [
  ...
  {
    id: 'folha', label: 'Folha', TabIcon: IUsers,
    desc: 'Gestão de folha de pagamento e obrigações trabalhistas.',
    items: [
      { name: 'Controle dos funcionários', CardIcon: IUserCheck, accent: '#7C3AED', soon: true, desc: 'Gerencie admissões, demissões, férias e obrigações trabalhistas dos funcionários.' },
    ],
  },
  {
