...
export const HUB_MODULES = [
  ...
  { slug: 'contabil', name: 'Contábil', icon: '📒', section: 'categorias',
    status: 'soon', description: 'Grade dos módulos contábeis.' },
  ...
  { slug: 'codificador', name: 'Codificador de Arquivos', icon: '🔢',
    section: 'ferramentas', status: 'soon',
  ...
  { slug: 'prazos', name: 'Gestão de Prazos', icon: '⏰',
    section: 'ferramentas', status: 'soon',
    description: 'Tarefas, vencimentos e alertas.' },
