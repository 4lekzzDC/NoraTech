// Nori em vetor — reserva usada quando a arte em PNG não está disponível.
//
// Fica aqui em vez de ser apagado porque garante que o hero nunca aparece
// com um buraco no lugar do mascote, seja porque o arquivo ainda não foi
// adicionado, seja porque a requisição dele falhou.
//
...
export default function NoriVector({ className = '', style = {} }) {
  return (
    <svg
