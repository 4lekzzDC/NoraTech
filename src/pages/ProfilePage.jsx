...
export default function ProfilePage() {
  ...
  const handleChangePassword = async (e) => {
    ...
    if (newPassword.length < 8) {
      return showToast('Nova senha deve ter pelo menos 8 caracteres', 'error');
    }
    setPassLoading(true);
    try {
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                <button
                  ...
                  style={{ ...btnPrimary, padding: '9px 18px', fontSize: '0.82rem' }}
                >
        ...
        <Section title="Alterar senha">
          <form onSubmit={handleChangePassword}>
            ...
            <Field label="Confirmar nova senha">
              <input
                className="profile-input"
                style={{ ...inputStyle, borderColor: confirmPassword && confirmPassword !== newPassword ? 'rgba(255,80,80,0.4)' : undefined }}
                type="password"
