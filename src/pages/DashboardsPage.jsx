    ...
    <div style={{ background: "#08080a", color: "#eeede9", fontFamily: "'Manrope', sans-serif", minHeight: "100vh", overflowX: "hidden" }}>
      <style>{`
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .feature-card:hover { transform: translateY(-4px); border-color: rgba(255,107,157,0.32) !important; box-shadow: 0 20px 60px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,107,157,0.1); }
      ...
      <section className="svc-hero" style={{ position: "relative", zIndex: 1, maxWidth: 1120, margin: "0 auto", padding: "120px 40px 72px" }}>
        <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "6px 14px", background: `${ACCENT}14`, border: `1px solid ${ACCENT}33`, borderRadius: 100, marginBottom: 28 }}>
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "0.68rem", fontWeight: 700, color: ACCENT, letterSpacing: 2.5 }}>S.03 · SERVIÇO</span>
        </div>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 12 }}>
          <a className="cta-btn" href="https://wa.me/5511932227752?text=Ol%C3%A1%2C%20gostaria%20de%20conversar%20sobre%20dashboards%20e%20BI." target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "14px 28px", background: "#c8ff00", color: "#08080a", borderRadius: 100, fontWeight: 700, fontSize: "0.9rem" }}>
      ...
      <main className="svc-section" style={{ position: "relative", zIndex: 1, maxWidth: 1120, margin: "0 auto", padding: "40px 40px 140px" }}>
        ...
        {/* Use cases */}
        <section style={sectionStyle}>
          <span style={labelStyle}>Painéis que entregamos</span>
        ...
        {/* Stack */}
        <section style={sectionStyle}>
          <span style={labelStyle}>Stack & ferramentas</span>
        ...
        <section className="svc-cta" style={{ marginTop: 72, padding: 56, background: `linear-gradient(135deg, ${ACCENT}14 0%, rgba(200,255,0,0.05) 100%)`, border: `1px solid ${ACCENT}33`, borderRadius: 24, textAlign: "center" }}>
          ...
          <a className="cta-btn" href="https://wa.me/5511932227752?text=Ol%C3%A1%2C%20gostaria%20de%20ver%20um%20prot%C3%B3tipo%20de%20dashboard." target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "14px 28px", background: "#c8ff00", color: "#08080a", borderRadius: 100, fontWeight: 700, fontSize: "0.92rem" }}>
