      ...
      <main style={{ position: "relative", zIndex: 1, maxWidth: 780, margin: "0 auto", padding: "80px 32px 120px" }}>
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: 40 }}>
          <section style={sectionStyle}>
            ...
            <p style={pStyle}>
              Ao acessar e utilizar os servicos oferecidos pela Noratech ("nos", "nosso" ou "empresa"), incluindo Finzo App, WhatsApp Bot e Sites para Empresas, voce concorda integralmente com estes Termos de Uso. Caso nao concorde com alguma disposicao, recomendamos que nao utilize nossos servicos.
            </p>
          </section>

          <section style={sectionStyle}>
            <h2 style={h2Style}>2. Descricao dos Servicos</h2>
            <p style={pStyle}>A Noratech oferece os seguintes produtos e servicos:</p>
            <ul style={listStyle}>
          ...
          <section style={sectionStyle}>
            ...
            <p style={pStyle}>
              Todo o conteudo, design, codigo-fonte, marcas, logos e materiais presentes em nossos produtos e servicos sao de propriedade da Noratech ou de seus licenciadores, protegidos pelas leis de propriedade intelectual.
            </p>
            <p style={pStyle}>
          ...
          <section style={sectionStyle}>
            ...
            <p style={pStyle}>
              Nossos servicos sao fornecidos "como estao". Na extensao maxima permitida por lei, a Noratech nao sera responsavel por danos indiretos, incidentais, especiais ou consequenciais decorrentes do uso ou impossibilidade de uso dos servicos.
            </p>
            <p style={pStyle}>
