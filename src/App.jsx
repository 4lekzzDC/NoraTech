    ...
    <div style={{ background: "#08080a", color: "#eeede9", fontFamily: "'Manrope', sans-serif", overflowX: "hidden", minHeight: "100vh" }}>
      ...
      <div style={{ position: "fixed", top: 14, left: "50%", transform: "translateX(-50%)", zIndex: 1000, width: "auto", maxWidth: "calc(100% - 28px)" }}>
        <nav style={{
          ...
          <a href="#area-cliente" className="nav-link" style={{ padding: "8px 18px", background: "#c8ff00", color: "#08080a", fontWeight: 700, borderRadius: 100 }}>Área do Cliente</a>
        </nav>
      </div>
      ...
      {menuOpen && (
        <div className="mobile-menu" style={{ display: "none" }}>
          ...
          <a href="#area-cliente" className="nav-link mobile-cta" onClick={() => setMenuOpen(false)}>Área do Cliente</a>
        </div>
      )}
      ...
      <section id="produtos" className="section-padding" style={{ padding: "140px 60px", maxWidth: 1440, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        <Reveal delay={0.1}>
          <h2 style={{ fontSize: "clamp(2rem, 3.5vw, 3.2rem)", fontWeight: 800, letterSpacing: -1.5, marginBottom: 14 }}>
            Projetos em <span style={{ fontFamily: "'Cormorant Garamond', serif", fontStyle: "italic", fontWeight: 600 }}>atividade</span>
          </h2>
        </Reveal>
        <Reveal delay={0.15}>
          <p style={{ fontSize: "1rem", color: "rgba(255,255,255,0.4)", maxWidth: 560, lineHeight: 1.6, marginBottom: 64 }}>
